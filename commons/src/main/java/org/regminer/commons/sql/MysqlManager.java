    ...
    public static List<Regression> getRegressions(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                regression.setBfcId(rs.getString("bfc"));
                regression.setBuggyId(rs.getString("buggy"));
                regression.setBicId(rs.getString("bic"));
                regression.setWorkId(rs.getString("work"));
